...
class Live_Cache_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'live_cache_widget', 'description' => __('The contents of this widget will be updated on all open pages within a minute of you saving it here. This will happen automatically without anyone needing to refresh their browser.'));
